...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=husk1Summoner] ~~~ summon minecraft:husk ~~~ aw:level_2 "尸壳 | lv.2"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..6}] ~~~ execute @e[name=husk1Summoner] ~~~ summon minecraft:husk ~~~ aw:level_1 "尸壳 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=husk1Summoner] ~~~ summon minecraft:husk ~~~ aw:level_2 "尸壳 | lv.2"
