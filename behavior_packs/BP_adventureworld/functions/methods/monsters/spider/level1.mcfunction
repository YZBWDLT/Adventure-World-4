...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=spider1Summoner] ~~~ summon minecraft:spider ~~~ aw:level_1 "蜘蛛 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..}] ~~~ execute @e[name=spider1Summoner] ~~~ summon minecraft:spider ~~~ aw:level_1 "蜘蛛 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=spider1Summoner] ~~~ summon minecraft:spider ~~~ aw:level_1 "蜘蛛 | lv.1"
