...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=hoglin1Summoner] ~~~ summon minecraft:hoglin ~~~ aw:level_2 "疣猪兽 | lv.2"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..6}] ~~~ execute @e[name=hoglin1Summoner] ~~~ summon minecraft:hoglin ~~~ aw:level_1 "疣猪兽 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=hoglin1Summoner] ~~~ summon minecraft:hoglin ~~~ aw:level_2 "疣猪兽 | lv.2"
