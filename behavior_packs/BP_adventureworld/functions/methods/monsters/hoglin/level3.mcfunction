...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=hoglin3Summoner] ~~~ summon minecraft:hoglin ~~~ aw:level_3 "疣猪兽 | lv.3"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..}] ~~~ execute @e[name=hoglin3Summoner] ~~~ summon minecraft:hoglin ~~~ aw:level_3 "疣猪兽 | lv.3"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=hoglin3Summoner] ~~~ summon minecraft:hoglin ~~~ aw:level_3 "疣猪兽 | lv.3"
