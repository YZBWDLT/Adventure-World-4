...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=stray1Summoner] ~~~ summon minecraft:stray ~~~ aw:level_1 "流浪者 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..}] ~~~ execute @e[name=stray1Summoner] ~~~ summon minecraft:stray ~~~ aw:level_1 "流浪者 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=stray1Summoner] ~~~ summon minecraft:stray ~~~ aw:level_1 "流浪者 | lv.1"
