...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=stray4Summoner] ~~~ summon minecraft:stray ~~~ aw:level_4 "流浪者 | lv.4"
