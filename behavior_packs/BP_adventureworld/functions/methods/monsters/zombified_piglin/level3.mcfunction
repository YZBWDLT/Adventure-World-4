...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=zombifiedPiglin3Summoner] ~~~ summon zombie_pigman ~~~ aw:level_4 "僵尸猪灵 | lv.4"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..6}] ~~~ execute @e[name=zombifiedPiglin3Summoner] ~~~ summon zombie_pigman ~~~ aw:level_3 "僵尸猪灵 | lv.3"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=zombifiedPiglin3Summoner] ~~~ summon zombie_pigman ~~~ aw:level_4 "僵尸猪灵 | lv.4"
