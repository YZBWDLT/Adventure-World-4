...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=zombie1Summoner] ~~~ summon minecraft:zombie ~~~ aw:level_2 "僵尸 | lv.2"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..6}] ~~~ execute @e[name=zombie1Summoner] ~~~ summon minecraft:zombie ~~~ aw:level_1 "僵尸 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=zombie1Summoner] ~~~ summon minecraft:zombie ~~~ aw:level_2 "僵尸 | lv.2"
