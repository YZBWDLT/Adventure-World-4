...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=caveSpider2Summoner] ~~~ summon cave_spider ~~~ aw:level_2 "洞穴蜘蛛 | lv.2"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..}] ~~~ execute @e[name=caveSpider2Summoner] ~~~ summon cave_spider ~~~ aw:level_2 "洞穴蜘蛛 | lv.2"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=caveSpider2Summoner] ~~~ summon cave_spider ~~~ aw:level_2 "洞穴蜘蛛 | lv.2"
