...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=skeleton4Summoner] ~~~ replaceitem entity @e[x=~,y=~,z=~,r=1,type=skeleton] slot.armor.chest 0 diamond_chestplate
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=skeleton4Summoner] ~~~ replaceitem entity @e[x=~,y=~,z=~,r=1,type=skeleton] slot.armor.legs 0 diamond_leggings
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=skeleton4Summoner] ~~~ replaceitem entity @e[x=~,y=~,z=~,r=1,type=skeleton] slot.armor.feet 0 diamond_boots
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=skeleton4Summoner] ~~~ replaceitem entity @e[x=~,y=~,z=~,r=1,type=skeleton] slot.weapon.mainhand 0 bow
