...
### 玩家数目  1   2~3 4~6 7~10
### 怪物倍率  1   2   3   4
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=1..}] ~~~ execute @e[name=drowned3Summoner] ~~~ summon drowned ~~~ minecraft:as_adult "溺尸 | lv.3"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=drowned3Summoner] ~~~ summon drowned ~~~ minecraft:as_adult "溺尸 | lv.3"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..}] ~~~ execute @e[name=drowned3Summoner] ~~~ summon drowned ~~~ minecraft:as_adult "溺尸 | lv.3"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=drowned3Summoner] ~~~ summon drowned ~~~ minecraft:as_adult "溺尸 | lv.3"
