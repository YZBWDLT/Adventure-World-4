...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..}] ~~~ execute @e[name=zombieBaby1Summoner] ~~~ summon minecraft:zombie ~~~ aw:level_2_baby "小僵尸 | lv.2"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..6}] ~~~ execute @e[name=zombieBaby1Summoner] ~~~ summon minecraft:zombie ~~~ aw:level_1_baby "小僵尸 | lv.1"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=zombieBaby1Summoner] ~~~ summon minecraft:zombie ~~~ aw:level_2_baby "小僵尸 | lv.2"
