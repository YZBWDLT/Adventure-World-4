...
execute @e[name=randomMonster,scores={background=1}] ~~~ summon je:marker -75 -37 35 "aw:as_summoner" "witchSummoner"
execute @e[name=randomMonster,scores={background=2}] ~~~ summon je:marker -75 -37 35 "aw:as_summoner" "creeperNormalSummoner"
