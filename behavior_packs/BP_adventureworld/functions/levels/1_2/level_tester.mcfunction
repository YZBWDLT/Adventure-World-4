...
execute @e[name=level,scores={stats=121}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/1_2/bonus
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/1_2/game_lose
