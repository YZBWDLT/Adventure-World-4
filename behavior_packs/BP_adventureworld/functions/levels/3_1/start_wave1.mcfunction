...
execute @e[name=level,scores={background=310}] ~~~ execute @a[tag=alive] -188 -21 26 function system/summon/skeleton1
execute @e[name=level,scores={background=310}] ~~~ execute @a[tag=alive] -187 -21 33 function system/summon/spider1
execute @e[name=level,scores={background=310}] ~~~ execute @a[tag=alive] -197 -21 34 function system/summon/drowned1
