...
execute @e[name=level,scores={stats=312}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/3_1/bonus
execute @e[name=level,scores={stats=311}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_1/start_wave2
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/3_1/game_lose
