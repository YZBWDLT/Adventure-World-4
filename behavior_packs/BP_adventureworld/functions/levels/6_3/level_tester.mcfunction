...
execute @e[name=level,scores={stats=634}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/6_3/bonus
execute @e[name=level,scores={stats=631}] ~~~ execute @a[tag=!playing] ~~~ function levels/6_3/start_wave2
execute @e[name=level,scores={stats=632}] ~~~ execute @a[tag=!playing] ~~~ function levels/6_3/start_wave3
execute @e[name=level,scores={stats=633}] ~~~ execute @a[tag=!playing] ~~~ function levels/6_3/start_wave4
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/6_3/game_lose
