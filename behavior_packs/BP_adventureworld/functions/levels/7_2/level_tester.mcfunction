...
execute @e[name=level,scores={stats=723}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/7_2/bonus
execute @e[name=level,scores={stats=721}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_2/start_wave2
execute @e[name=level,scores={stats=722}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_2/start_wave3
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/7_2/game_lose
