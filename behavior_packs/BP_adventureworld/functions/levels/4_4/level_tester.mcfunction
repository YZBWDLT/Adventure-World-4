...
execute @e[name=level,scores={background=441}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/4_4/bonus
...
execute @e[name=alivePlayersAmount,scores={background=0}] ~~~ function levels/4_4/game_lose
