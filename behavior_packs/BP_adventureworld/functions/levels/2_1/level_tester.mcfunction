...
execute @e[name=level,scores={stats=212}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/2_1/bonus
execute @e[name=level,scores={stats=211}] ~~~ execute @a[tag=!playing] ~~~ function levels/2_1/start_wave2
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/2_1/game_lose
