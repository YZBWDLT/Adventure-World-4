...
execute @e[name=level,scores={stats=344}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/3_4/bonus
execute @e[name=level,scores={stats=341}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_4/start_wave2
execute @e[name=level,scores={stats=342}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_4/start_wave3
execute @e[name=level,scores={stats=343}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_4/start_wave4
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/3_4/game_lose
