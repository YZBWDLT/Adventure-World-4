...
execute @e[name=level,scores={background=712}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/7_1/bonus
execute @e[name=level,scores={background=711}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_1/start_wave2
