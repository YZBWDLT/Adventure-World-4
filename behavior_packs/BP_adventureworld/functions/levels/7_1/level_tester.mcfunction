...
execute @e[name=level,scores={stats=712}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/7_1/bonus
execute @e[name=level,scores={stats=711}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_1/start_wave2
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/7_1/game_lose
