...
execute @e[name=timeline,scores={time=280}] ~~~ fill -88 0 104 -86 0 106 minecraft:quartz_block["chisel_type":"smooth"]
...
execute @e[name=timeline,scores={time=760}] ~~~ fill -88 0 104 -86 0 106 minecraft:air
...
execute @e[name=timeline,scores={time=801}] ~~~ tag @a remove bonusTraversing
execute @e[name=timeline,scores={time=801}] ~~~ scoreboard players set @e[name=bonusTraversing] active 1
...
execute @e[name=timeline,scores={time=1060}] ~~~ fill -150 -18 102 -150 -16 100 minecraft:nether_brick_fence
...
execute @e[name=timeline,scores={time=1260}] ~~~ function levels/7_1/start_wave1

## 时间线结束
execute @e[name=timeline,scores={time=1260}] ~~~ scoreboard players set @s active 0
