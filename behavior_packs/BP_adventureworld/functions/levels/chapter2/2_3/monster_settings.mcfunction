...
# --- 第1波 ---
execute @e[name=wave,scores={data=1}] ~~~ summon je:marker -159 -21 66 "aw:as_summoner" "skeleton1Summoner"
execute @e[name=wave,scores={data=1}] ~~~ summon je:marker -159 -21 56 "aw:as_summoner" "skeleton1Summoner"
execute @e[name=wave,scores={data=1}] ~~~ summon je:marker -149 -21 56 "aw:as_summoner" "skeleton1Summoner"
execute @e[name=wave,scores={data=1}] ~~~ summon je:marker -149 -21 66 "aw:as_summoner" "skeleton1Summoner"
