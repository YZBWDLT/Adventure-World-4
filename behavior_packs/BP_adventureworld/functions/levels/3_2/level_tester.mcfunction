...
execute @e[name=level,scores={stats=323}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/3_2/bonus
execute @e[name=level,scores={stats=321}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_2/start_wave2
execute @e[name=level,scores={stats=322}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_2/start_wave3
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/3_2/game_lose
