...
execute @e[name=level,scores={stats=132}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/1_3/bonus
execute @e[name=level,scores={stats=131}] ~~~ execute @a[tag=!playing] ~~~ function levels/1_3/start_wave2
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/1_3/game_lose
