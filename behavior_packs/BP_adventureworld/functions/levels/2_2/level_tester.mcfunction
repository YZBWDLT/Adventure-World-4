...
execute @e[name=level,scores={stats=223}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/2_2/bonus
execute @e[name=level,scores={stats=222}] ~~~ execute @a[tag=!playing] ~~~ function levels/2_2/start_wave3
execute @e[name=level,scores={stats=221}] ~~~ execute @a[tag=!playing] ~~~ function levels/2_2/start_wave2
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/2_2/game_lose
