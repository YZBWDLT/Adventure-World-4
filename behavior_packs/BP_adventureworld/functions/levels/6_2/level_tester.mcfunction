...
execute @e[name=level,scores={stats=623}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/6_2/bonus
execute @e[name=level,scores={stats=621}] ~~~ execute @a[tag=!playing] ~~~ function levels/6_2/start_wave2
execute @e[name=level,scores={stats=622}] ~~~ execute @a[tag=!playing] ~~~ function levels/6_2/start_wave3
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/6_2/game_lose
