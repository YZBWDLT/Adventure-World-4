...
execute @e[name=level,scores={stats=423}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/4_2/bonus
execute @e[name=level,scores={stats=421}] ~~~ execute @a[tag=!playing] ~~~ function levels/4_2/start_wave2
execute @e[name=level,scores={stats=422}] ~~~ execute @a[tag=!playing] ~~~ function levels/4_2/start_wave3
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/4_2/game_lose
