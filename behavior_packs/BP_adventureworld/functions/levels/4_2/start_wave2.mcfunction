...
execute @e[name=level,scores={background=421}] ~~~ execute @a[tag=alive] -162 7 4 function system/summon/stray2
execute @e[name=level,scores={background=421}] ~~~ execute @a[tag=alive] -159 7 -0 function system/summon/guardian1
execute @e[name=level,scores={background=421}] ~~~ execute @a[tag=alive] -156 7 6 function system/summon/guardian1
