...
execute @a[tag=playing,c=1] ~~~ execute @e[name=monsterAmount,scores={background=0}] ~~~ scoreboard players set @e[name=level] background 641
...
## 当玩家结束战斗后给予奖励
execute @e[name=level,scores={background=641}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/6_4/bonus
...
execute @e[name=alivePlayersAmount,scores={background=0}] ~~~ function levels/6_4/game_lose
