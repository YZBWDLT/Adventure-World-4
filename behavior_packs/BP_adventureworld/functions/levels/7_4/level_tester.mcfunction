...
execute @e[name=level,scores={background=745}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/7_4/bonus
execute @e[name=level,scores={background=741}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_4/start_wave2
execute @e[name=level,scores={background=742}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_4/start_wave3
execute @e[name=level,scores={background=743}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_4/start_wave4
execute @e[name=level,scores={background=744}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_4/start_wave5
...
execute @e[name=alivePlayersAmount,scores={background=0}] ~~~ function levels/7_4/game_lose
