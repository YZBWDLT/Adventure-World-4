...
execute @e[name=level,scores={background=434}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter4/4_3/bonus
execute @e[name=level,scores={background=431}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter4/4_3/start_wave2
execute @e[name=level,scores={background=432}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter4/4_3/start_wave3
execute @e[name=level,scores={background=433}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter4/4_3/start_wave4
