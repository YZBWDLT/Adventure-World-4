...
execute @e[name=level,scores={background=413}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter4/4_1/bonus
execute @e[name=level,scores={background=411}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter4/4_1/start_wave2
execute @e[name=level,scores={background=412}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter4/4_1/start_wave3
