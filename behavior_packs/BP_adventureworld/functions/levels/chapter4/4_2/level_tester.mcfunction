...
execute @e[name=level,scores={background=423}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter4/4_2/bonus
execute @e[name=level,scores={background=421}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter4/4_2/start_wave2
execute @e[name=level,scores={background=422}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter4/4_2/start_wave3
