...
execute @e[name=dialogue,scores={time=100}] ~~~ tellraw @a {"rawtext":[{"text":"* §c米云溪： §7......没有。"}]}
execute @e[name=dialogue,scores={time=200}] ~~~ tellraw @a {"rawtext":[{"text":"* §f林乐（我）： §7真浪费，这么好的武器没人用。"}]}
