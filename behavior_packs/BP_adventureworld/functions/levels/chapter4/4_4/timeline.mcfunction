...
execute @e[name=randomLocation,scores={data=1}] ~~~ summon je:marker -122 -31 6 "aw:as_summoner" "summonLocation"
execute @e[name=randomLocation,scores={data=2}] ~~~ summon je:marker -130 -31 -2 "aw:as_summoner" "summonLocation"
execute @e[name=randomLocation,scores={data=3}] ~~~ summon je:marker -130 -31 14 "aw:as_summoner" "summonLocation"
execute @e[name=randomLocation,scores={data=4}] ~~~ summon je:marker -130 -31 6 "aw:as_summoner" "summonLocation"
execute @e[name=randomLocation,scores={data=5}] ~~~ summon je:marker -138 -31 6 "aw:as_summoner" "summonLocation"
