...
### 单人E~S、难度4、非一命
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=score,scores={data=40..}] ~~~ execute @e[name=difficulty,scores={data=4}] ~~~ tellraw @a[scores={deathTimes=!0}] {"rawtext":[{"translate":"* §a星辰（xc13599305）： §7要不要挑战一下一命通关难度4呢？"}]}
### 单人E~S、难度4、一命
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=score,scores={data=40..}] ~~~ execute @e[name=difficulty,scores={data=4}] ~~~ tellraw @a[scores={deathTimes=0}] {"rawtext":[{"translate":"* §a星辰（xc13599305）： §7你真的做到了......（震惊"}]}
### 单人F
