...
### 单人、F~、难度4、非一命
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficulty,scores={data=4}] ~~~ execute @e[name=score,scores={data=!-1}] ~~~ tellraw @a[scores={deathTimes=!0}] {"rawtext":[{"translate":"* §a帕（Hfpa0117）： §7你的技术已经超过很多人了，要不要试一下0死亡嘛嘿嘿~~~"}]}
### 单人、F~、难度4、一命
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficulty,scores={data=4}] ~~~ execute @e[name=score,scores={data=!-1}] ~~~ tellraw @a[scores={deathTimes=0}] {"rawtext":[{"translate":"* §a帕（Hfpa0117）： §7能看到这段对话的人应该很少吧（？）厉害哒！相信你已经可以秒杀绝大部分的pve地图了awa（在7-5出来之前我甚至还设置了四级难度一命无药通关的特殊对话，可是这个用手机打出来非常难，所以放弃了qwq）"}]}
### 单人、F~D、难度1~3
...
### 单人、C~S、难度1、非一命
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficulty,scores={data=1}] ~~~ execute @e[name=score,scores={data=60..}] ~~~ tellraw @a[scores={deathTimes=!0}] {"rawtext":[{"translate":"* §a帕（Hfpa0117）： §7恭喜你通过此次试炼！可以的话尝试考虑更高的难度吧！"}]}
### 单人、C~S、难度1、一命
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficulty,scores={data=1}] ~~~ execute @e[name=score,scores={data=60..}] ~~~ tellraw @a[scores={deathTimes=0}] {"rawtext":[{"translate":"* §a帕（Hfpa0117）： §7恭喜，你的PVE技术合格啦~"}]}
### 单人、C~S、难度2~3
