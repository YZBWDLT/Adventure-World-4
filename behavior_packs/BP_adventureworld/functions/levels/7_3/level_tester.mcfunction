...
execute @e[name=level,scores={stats=734}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/7_3/bonus
execute @e[name=level,scores={stats=731}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_3/start_wave2
execute @e[name=level,scores={stats=732}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_3/start_wave3
execute @e[name=level,scores={stats=733}] ~~~ execute @a[tag=!playing] ~~~ function levels/7_3/start_wave4
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/7_3/game_lose
