...
execute @e[name=dialogue,scores={active=2,time=540}] ~~~ tellraw @a {"rawtext":[{"text":"* §c米云溪： §7啊？......嗯没事了，林乐你直接前往下一个神殿就行(..＞ᴗ＜..)"}]}
execute @e[name=dialogue,scores={active=2,time=620}] ~~~ tellraw @a {"rawtext":[{"text":"* §f林乐（我）： §7喂喂，怎么就没事了啊可恶，云儿你把话讲明白啊！"}]}
execute @e[name=dialogue,scores={active=2,time=700}] ~~~ tellraw @a {"rawtext":[{"text":"* §f林乐（我）： §7云儿？"}]}
