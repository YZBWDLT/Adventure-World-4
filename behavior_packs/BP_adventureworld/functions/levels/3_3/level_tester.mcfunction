...
execute @e[name=level,scores={stats=333}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/3_3/bonus
execute @e[name=level,scores={stats=331}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_3/start_wave2
execute @e[name=level,scores={stats=332}] ~~~ execute @a[tag=!playing] ~~~ function levels/3_3/start_wave3
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/3_3/game_lose
