...
execute @e[name=level,scores={stats=111}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/1_1/bonus
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/1_1/game_lose
