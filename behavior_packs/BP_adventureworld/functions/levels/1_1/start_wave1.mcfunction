...
execute @e[name=level,scores={background=110}] ~~~ execute @a[tag=alive] -123 1 28 function system/summon/zombie1
execute @e[name=level,scores={background=110}] ~~~ execute @a[tag=alive] -110 1 28 function system/summon/zombie1
