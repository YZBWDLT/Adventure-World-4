...
## 设置level分数
scoreboard players set @e[name=level] stats 110
...
execute @e[name=level,scores={stats=110}] ~~~ execute @a[tag=alive] -123 1 28 function system/summon/zombie1
execute @e[name=level,scores={stats=110}] ~~~ execute @a[tag=alive] -110 1 28 function system/summon/zombie1
