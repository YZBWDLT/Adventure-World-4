...
execute @e[name=level,scores={background=734}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter7/7_3/bonus
execute @e[name=level,scores={background=731}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter7/7_3/start_wave2
execute @e[name=level,scores={background=732}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter7/7_3/start_wave3
execute @e[name=level,scores={background=733}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter7/7_3/start_wave4
