...
execute @e[name=level,scores={background=712}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter7/7_1/bonus
execute @e[name=level,scores={background=711}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter7/7_1/start_wave2
