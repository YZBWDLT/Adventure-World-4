...
execute @e[name=wave,scores={data=2}] ~~~ summon aw:marker -164 -18 104 "aw:as_summoner" "hoglin2Summoner"
execute @e[name=wave,scores={data=2}] ~~~ summon aw:marker -165 -17 114 "aw:as_summoner" "hoglin2Summoner"
...
execute @e[name=wave,scores={data=2}] ~~~ summon aw:marker -177 -17 114 "aw:as_summoner" "piglin2Summoner"
...
# --- 第3波 ---
execute @e[name=wave,scores={data=3}] ~~~ summon aw:marker -162 -18 106 "aw:as_summoner" "piglinBruteBossSummoner"
