...
execute @e[name=level,scores={background=723}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter7/7_2/bonus
execute @e[name=level,scores={background=721}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter7/7_2/start_wave2
execute @e[name=level,scores={background=722}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter7/7_2/start_wave3
