...
## 设定各个技能所对应的技能倒计时
### ~ 技能1：召唤怪物 ~
execute @e[family=evoker,scores={temp=1..20}] ~~~ scoreboard players set @e[name=timeline,scores={temp=0}] temp2 5
### ~ 技能2：空袭 ~
...
## 执行特定技能
### ~ 技能1：召唤怪物 ~
execute @e[family=evoker,scores={temp=1..20}] ~~~ execute @e[name=timeline,scores={temp2=5}] ~~~ function levels/chapter7/7_5/boss_skills/skill_1_1
### ~ 技能2：空袭 ~
...
execute @e[family=evoker,scores={temp=41..60}] ~~~ execute @e[name=timeline,scores={temp2=5}] ~~~ structure load 7_5_phase_1_lava -246 -54 23 0_degrees none layer_by_layer 3.00
...
execute @e[family=evoker,scores={temp=41..60}] ~~~ execute @e[name=timeline,scores={temp2=0}] ~~~ structure load 7_5_phase_1 -246 -54 23
### ~ 技能4：回血 ~
