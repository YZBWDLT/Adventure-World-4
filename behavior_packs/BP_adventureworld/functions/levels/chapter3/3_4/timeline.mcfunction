...
scoreboard players set @a[x=-172,y=-1,z=30,r=2,scores={isAlive=1}] isAlive 0
...
execute @e[name=wave,scores={background=1}] ~~~ execute @e[name=lastWaveCompleted,scores={background=1}] ~~~ summon je:marker -169 -14 21 "aw:as_summoner" "creeper2Summoner"
...
execute @e[name=wave,scores={background=2}] ~~~ execute @e[name=lastWaveCompleted,scores={background=1}] ~~~ summon je:marker -176 -9 19 "aw:as_summoner" "creeper2Summoner"
...
execute @e[name=wave,scores={background=3}] ~~~ execute @e[name=lastWaveCompleted,scores={background=1}] ~~~ summon je:marker -169 2 23 "aw:as_summoner" "creeper2Summoner"
...
execute @e[name=wave,scores={background=4}] ~~~ execute @e[name=lastWaveCompleted,scores={background=1}] ~~~ summon je:marker -173 -14 26 "aw:as_summoner" "creeper2Summoner"
execute @e[name=wave,scores={background=4}] ~~~ execute @e[name=lastWaveCompleted,scores={background=1}] ~~~ summon je:marker -169 2 23 "aw:as_summoner" "creeper2Summoner"
