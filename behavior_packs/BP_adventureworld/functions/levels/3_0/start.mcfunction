...
setblock -186 -20 29 minecraft:air
...
fill -169 -14 27 -177 15 19 minecraft:air[] replace minecraft:sponge["sponge_type":"wet"]
fill -169 -14 27 -177 15 19 minecraft:air[] replace minecraft:sponge["sponge_type":"dry"]