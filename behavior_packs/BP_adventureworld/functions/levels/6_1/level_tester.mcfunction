...
execute @e[name=level,scores={stats=612}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/6_1/bonus
execute @e[name=level,scores={stats=611}] ~~~ execute @a[tag=!playing] ~~~ function levels/6_1/start_wave2
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/6_1/game_lose
