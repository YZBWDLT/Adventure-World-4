...
execute @e[name=level,scores={stats=234}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/2_3/bonus
execute @e[name=level,scores={stats=233}] ~~~ execute @a[tag=!playing] ~~~ function levels/2_3/start_wave4
execute @e[name=level,scores={stats=232}] ~~~ execute @a[tag=!playing] ~~~ function levels/2_3/start_wave3
execute @e[name=level,scores={stats=231}] ~~~ execute @a[tag=!playing] ~~~ function levels/2_3/start_wave2
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/2_3/game_lose
