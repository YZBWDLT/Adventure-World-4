...
execute @e[name=dialogue,scores={time=420}] ~~~ execute @e[name=isNetease,scores={data=0}] ~~~ tellraw @a {"rawtext":[{"text":"* §e张宇： §7在山的后面我看到了一片小湖，湖的中央居然有一座上了年代的建筑......好像是通往地下的某个神庙的入口。"}]}
execute @e[name=dialogue,scores={time=420}] ~~~ execute @e[name=isNetease,scores={data=1}] ~~~ tellraw @a {"rawtext":[{"text":"* §e张宇： §7在山的后面我看到了一片小湖，湖的中间居然有一座上了年代的建筑......好像是通往地下的某个神庙的入口。"}]}
