...
execute @e[name=level,scores={stats=413}] ~~~ execute @a[tag=!playing,c=1] ~~~ function levels/4_1/bonus
execute @e[name=level,scores={stats=411}] ~~~ execute @a[tag=!playing] ~~~ function levels/4_1/start_wave2
execute @e[name=level,scores={stats=412}] ~~~ execute @a[tag=!playing] ~~~ function levels/4_1/start_wave3
...
execute @e[name=alivePlayersAmount,scores={stats=0}] ~~~ function levels/4_1/game_lose
