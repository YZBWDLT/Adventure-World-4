...
execute @e[name=wave,scores={data=2}] ~~~ summon aw:marker -74 -19 -47 "aw:as_summoner" "witchSummoner"
execute @e[name=wave,scores={data=2}] ~~~ summon aw:marker -80 -20 -46 "aw:as_summoner" "caveSpider2Summoner"
execute @e[name=wave,scores={data=2}] ~~~ summon aw:marker -72 -19 -34 "aw:as_summoner" "caveSpider2Summoner"
...
execute @e[name=wave,scores={data=3}] ~~~ summon aw:marker -80 -16 -41 "aw:as_summoner" "witchSummoner"
execute @e[name=wave,scores={data=3}] ~~~ summon aw:marker -74 -16 -37 "aw:as_summoner" "witchSummoner"
