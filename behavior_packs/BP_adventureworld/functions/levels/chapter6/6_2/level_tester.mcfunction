...
execute @e[name=level,scores={background=623}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter6/6_2/bonus
execute @e[name=level,scores={background=621}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter6/6_2/start_wave2
execute @e[name=level,scores={background=622}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter6/6_2/start_wave3

# -----失败判定-----

## 对在重生点的玩家移除alive标签
execute @a[x=-79,y=-12,z=-31,dx=2,dy=3,dz=2] ~~~ scoreboard players set @s isAlive 0
