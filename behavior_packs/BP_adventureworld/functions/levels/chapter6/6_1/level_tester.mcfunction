...
execute @e[name=level,scores={background=612}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter6/6_1/bonus
execute @e[name=level,scores={background=611}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter6/6_1/start_wave2
