...
scoreboard players set @a[x=-66,y=-30,z=-54,r=2,scores={isAlive=1}] isAlive 0
...
execute @e[name=wave,scores={background=1}] ~~~ execute @e[name=lastWaveCompleted,scores={background=1}] ~~~ summon je:marker -83 -27 -52 "aw:as_summoner" "creeper1Summoner"
...
execute @e[name=wave,scores={background=2}] ~~~ execute @e[name=lastWaveCompleted,scores={background=1}] ~~~ summon je:marker -70 -30 -49 "aw:as_summoner" "creeper1Summoner"
