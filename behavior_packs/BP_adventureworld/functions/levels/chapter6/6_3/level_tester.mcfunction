...
execute @e[name=level,scores={background=634}] ~~~ execute @a[scores={isAlive=2},c=1] ~~~ function levels/chapter6/6_3/bonus
execute @e[name=level,scores={background=631}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter6/6_3/start_wave2
execute @e[name=level,scores={background=632}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter6/6_3/start_wave3
execute @e[name=level,scores={background=633}] ~~~ execute @a[scores={isAlive=2}] ~~~ function levels/chapter6/6_3/start_wave4
