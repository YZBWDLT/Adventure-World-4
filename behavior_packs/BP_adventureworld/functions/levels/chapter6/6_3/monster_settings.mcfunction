...
execute @e[name=wave,scores={data=2}] ~~~ summon aw:marker -79 -37 -10 "aw:as_summoner" "witchSummoner"
...
execute @e[name=wave,scores={data=3}] ~~~ summon aw:marker -69 -38 5 "aw:as_summoner" "witchSummoner"
