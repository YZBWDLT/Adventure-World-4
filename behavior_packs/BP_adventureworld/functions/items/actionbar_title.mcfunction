...
## --- 生命药水 II ---
execute @e[name=level,scores={background=221..}] ~~~ titleraw @a[hasitem={item=aw:health_potion_2,location=slot.weapon.mainhand}] actionbar {"rawtext":[{"text":"§6+64 生命值 (♥*32) §7| §6药水上限 §a1"}]}
...
## --- 抗性提升药水 I ---
execute @e[name=level,scores={background=131..}] ~~~ titleraw @a[hasitem={item=aw:resistance_potion_1,location=slot.weapon.mainhand}] actionbar {"rawtext":[{"text":"§6抗性提升 III (0:20) §7| §6药水上限 §a1"}]}

## --- 生命提升药水 I ---
execute @e[name=level,scores={background=231..}] ~~~ titleraw @a[hasitem={item=aw:health_boost_potion_1,location=slot.weapon.mainhand}] actionbar {"rawtext":[{"text":"§6+8 生命值 (♥*4) 上限 (2:00) §7| §6药水上限 §a1"}]}
