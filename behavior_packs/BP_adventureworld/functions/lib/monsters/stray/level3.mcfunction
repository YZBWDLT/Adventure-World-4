...
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=2..3}] ~~~ execute @e[name=stray3Summoner] ~~~ summon minecraft:stray ~~~ aw:level_4 "流浪者 | lv.4"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=4..6}] ~~~ execute @e[name=stray3Summoner] ~~~ summon minecraft:stray ~~~ aw:level_5 "流浪者 | lv.5"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={background=7..}] ~~~ execute @e[name=stray3Summoner] ~~~ summon minecraft:stray ~~~ aw:level_6 "流浪者 | lv.6"
