...
### 生成怪物
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={data=1}] ~~~ execute @e[name=drownedWithTridentSummoner] ~~~ summon minecraft:drowned ~~~ aw:level_1_with_trident "§c三叉戟溺尸"
execute @e[name=monsterSummonDelay,scores={time=0}] ~~~ execute @e[name=alivePlayersAmount,scores={data=2..3}] ~~~ execute @e[name=drownedWithTridentSummoner] ~~~ summon minecraft:drowned ~~~ aw:level_2_with_trident "§c三叉戟溺尸"
