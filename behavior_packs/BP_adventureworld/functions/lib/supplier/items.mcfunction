...
## --- 弓 ---
## 2-1结束后给予，始终保留
give @s[scores={temp=211..999},hasitem={item=bow,quantity=0}] bow 1 0 {"item_lock":{"mode":"lock_in_inventory"}}
...
replaceitem entity @s[scores={temp=641..999},hasitem={item=aw:diamond_helmet,quantity=0,location=slot.armor.head}] slot.armor.head 0 aw:diamond_helmet 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
replaceitem entity @s[scores={temp=641..999},hasitem={item=aw:diamond_boots,quantity=0,location=slot.armor.feet}] slot.armor.feet 0 aw:diamond_boots 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
replaceitem entity @s[scores={temp=331..999},hasitem={item=aw:quiver,quantity=0,location=slot.inventory,slot=25}] slot.inventory 25 aw:quiver 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
## --- 盾 ---
## 4-1结束后给予，始终保留
give @s[scores={temp=411..999},hasitem={item=shield,quantity=0}] shield 1 0 {"item_lock":{"mode":"lock_in_inventory"}}
...
replaceitem entity @s[scores={temp=431..999},hasitem={item=aw:diamond_leggings,quantity=0,location=slot.armor.legs}] slot.armor.legs 0 aw:diamond_leggings 1 0 {"item_lock":{"mode":"lock_in_slot"}}

## --- 钻石胸甲 ---
## 4-4结束后给予，始终保留 | 锁定到槽位上
replaceitem entity @s[scores={temp=441..999},hasitem={item=aw:diamond_chestplate,quantity=0,location=slot.armor.chest}] slot.armor.chest 0 aw:diamond_chestplate 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
give @s[scores={temp=709..999},hasitem={item=aw:wild_sword,quantity=0}] aw:wild_sword 1 0 {"item_lock":{"mode":"lock_in_inventory"}}
