...
tellraw @s[scores={temp=1}] {"rawtext":[{"translate":"settings.shouldForceSummonMonster = %%s §7# 是否强制立刻生成怪物，0：不启用，1：启用","with":{"rawtext":[{"score":{"objective":"settings","name":"@e[name=shouldForceSummonMonster]"}}]}}]}
