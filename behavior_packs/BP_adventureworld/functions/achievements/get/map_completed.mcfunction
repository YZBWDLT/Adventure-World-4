...
# 挑战自我 - 通过2级或更高难度的试炼
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficultyAdder,scores={settings=1..3}] ~~~ scoreboard players set achievement.singlePlayer.difficulty2 record 1
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficultyAdder,scores={settings=1..3}] ~~~ tellraw @a {"rawtext":[{"translate":"你已获得成就 §b[挑战自我]§f ！"}]}

# 举步维艰 - 通过3级或更高难度的试炼
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficultyAdder,scores={settings=2..3}] ~~~ scoreboard players set achievement.singlePlayer.difficulty3 record 1
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficultyAdder,scores={settings=2..3}] ~~~ tellraw @a {"rawtext":[{"translate":"你已获得困难成就 §d[举步维艰]§f ！"}]}

# 这不可能！ - 通过4级难度的试炼
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficultyAdder,scores={settings=3}] ~~~ scoreboard players set achievement.singlePlayer.difficulty4 record 1
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ execute @e[name=difficultyAdder,scores={settings=3}] ~~~ tellraw @a {"rawtext":[{"translate":"你已获得传奇成就 §e[这不可能！]§f ！"}]}
