...
## 弓 | 2-1解锁耐久III
execute @e[name=gameId,scores={data=211..}] ~~~ enchant @a[hasitem={item=bow,location=slot.weapon.mainhand}] unbreaking 3

## 弓 | 4-2解锁火矢
execute @e[name=gameId,scores={data=421..}] ~~~ enchant @a[hasitem={item=bow,location=slot.weapon.mainhand}] flame 1

## 弓 | 6-1解锁力量V
execute @e[name=gameId,scores={data=611..}] ~~~ enchant @a[hasitem={item=bow,location=slot.weapon.mainhand}] power 5
