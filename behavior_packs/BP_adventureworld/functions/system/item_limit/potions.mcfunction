...
execute @e[name=level,scores={background=111..210}] ~~~ give @a[scores={temp=1}] aw:health_potion_1 1 0
...
execute @e[name=level,scores={background=211..310}] ~~~ give @a[scores={temp=1}] aw:health_potion_1 2 0
scoreboard players set @a temp 0
## 3-1，上限+1
...
execute @e[name=level,scores={background=311..}] ~~~ give @a[scores={temp=1}] aw:health_potion_1 3 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=221..410}] ~~~ give @a[scores={temp=1}] aw:health_potion_2 1 0
scoreboard players set @a temp 0
## 4-1，上限+1
...
execute @e[name=level,scores={background=411..}] ~~~ give @a[scores={temp=1}] aw:health_potion_2 2 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=121..610}] ~~~ give @a[scores={temp=1}] aw:regeneration_potion_1 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=611..}] ~~~ give @a[scores={temp=1}] aw:regeneration_potion_2 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=231..440}] ~~~ give @a[scores={temp=1}] aw:health_boost_potion_1 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=441..}] ~~~ give @a[scores={temp=1}] aw:health_boost_potion_2 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=131..420}] ~~~ give @a[scores={temp=1}] aw:resistance_potion_1 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=421..}] ~~~ give @a[scores={temp=1}] aw:resistance_potion_2 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=341..640}] ~~~ give @a[scores={temp=1}] aw:strength_potion_1 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=641..}] ~~~ give @a[scores={temp=1}] aw:strength_potion_2 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=321..620}] ~~~ give @a[scores={temp=1}] aw:boost_potion_1 1 0
scoreboard players set @a temp 0
...
execute @e[name=level,scores={background=621..}] ~~~ give @a[scores={temp=1}] aw:boost_potion_2 1 0
scoreboard players set @a temp 0
