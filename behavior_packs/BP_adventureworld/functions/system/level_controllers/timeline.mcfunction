...
## --- 时间线 ---
execute @e[name=level,scores={background=1}] ~~~ function levels/open/timeline_before
execute @e[name=level,scores={background=2}] ~~~ function levels/open/timeline_after
