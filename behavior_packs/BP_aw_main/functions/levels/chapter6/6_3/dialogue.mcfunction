...
execute @e[name=dialogue,scores={time=80}] ~~~ execute @e[name=isNetease,scores={data=0}] ~~~ tellraw @a {"rawtext":[{"text":"* §c米云溪： §7【烈焰之魂镇守此地，熔岩之海将焚毁万物】，看样子，你马上就要面对山峦神殿的守关怪物了......小心！接下来的战场岩浆可能会上升啊！"}]}
execute @e[name=dialogue,scores={time=80}] ~~~ execute @e[name=isNetease,scores={data=1}] ~~~ tellraw @a {"rawtext":[{"text":"* §c米云溪： §7【烈焰之魂镇守此地，熔岩之海将焚毁万物】，看样子，你一会儿就要面对山峦神殿的守关怪物了......小心！接下来的战场岩浆可能会上升啊！"}]}
