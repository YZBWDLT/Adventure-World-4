...
## --- 第二波，生成怪物后地面塌陷 ---
execute @e[name=wave,scores={data=2}] ~~~ execute @e[name=monsterSummonDelay,scores={time=1}] ~~~ structure load aw:4_1_phase2 -168 16 -23 0_degrees none block_by_block 1.25
