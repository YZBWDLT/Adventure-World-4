...
# --- 获取上一局的开局设置 ---
scoreboard players operation @e[name=storyMode] data = temp.storyMode record
scoreboard players operation @e[name=difficultyAdder] data = temp.difficultyAdder record
