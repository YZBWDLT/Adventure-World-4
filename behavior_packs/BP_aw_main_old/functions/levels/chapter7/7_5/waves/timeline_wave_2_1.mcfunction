...
execute @e[name=timeline,scores={temp=0}] ~~~ scoreboard players random @e[family=evoker] temp 1 80
...
## 设定各个技能所对应的技能倒计时
### ~ 技能1：召唤怪物 ~
execute @e[family=evoker,scores={temp=1..20}] ~~~ scoreboard players set @e[name=timeline,scores={temp=0}] temp2 15
### ~ 技能2：空袭 ~
execute @e[family=evoker,scores={temp=21..40}] ~~~ scoreboard players set @e[name=timeline,scores={temp=0}] temp2 20
### ~ 技能3：岩浆上涨 ~
execute @e[family=evoker,scores={temp=41..60}] ~~~ scoreboard players set @e[name=timeline,scores={temp=0}] temp2 10
### ~ 技能4：回血 ~
...
### ~ 技能1：召唤怪物 ~
execute @e[family=evoker,scores={temp=1..20}] ~~~ execute @e[name=timeline,scores={temp=0}] ~~~ titleraw @a subtitle {"rawtext":[{"translate":"§c当心！即将有怪物生成！"}]}
### ~ 技能2：空袭 ~
execute @e[family=evoker,scores={temp=21..40}] ~~~ execute @e[name=timeline,scores={temp=0}] ~~~ execute @e[name=isNetease,scores={data=0}] ~~~ titleraw @a subtitle {"rawtext":[{"translate":"§c注意头顶！及时躲到掩体下面！"}]}
execute @e[family=evoker,scores={temp=21..40}] ~~~ execute @e[name=timeline,scores={temp=1}] ~~~ execute @e[name=isNetease,scores={data=0}] ~~~ titleraw @a subtitle {"rawtext":[{"translate":"§c注意头顶！及时躲到掩体下方！"}]}
### ~ 技能3：岩浆上涨 ~
execute @e[family=evoker,scores={temp=41..60}] ~~~ execute @e[name=timeline,scores={temp=0}] ~~~ titleraw @a subtitle {"rawtext":[{"translate":"§c熔岩上涨！及时躲到高处！"}]}
### ~ 技能4：回血 ~
...
## 执行特定技能
### ~ 技能1：召唤怪物 ~
execute @e[family=evoker,scores={temp=1..20}] ~~~ execute @e[name=timeline,scores={temp2=15}] ~~~ function levels/chapter7/7_5/boss_skills/skill_1_1
### ~ 技能2：空袭 ~
execute @e[family=evoker,scores={temp=21..40}] ~~~ execute @e[name=timeline,scores={temp2=!0}] ~~~ function levels/chapter7/7_5/boss_skills/skill_2_1
### ~ 技能3：岩浆上涨 ~
execute @e[family=evoker,scores={temp=41..60}] ~~~ execute @e[name=timeline,scores={temp2=6..10}] ~~~ execute @a ~~~ playsound bucket.fill_lava @s ~~~ 1 2 
execute @e[family=evoker,scores={temp=41..60}] ~~~ execute @e[name=timeline,scores={temp2=5}] ~~~ structure load aw:7_5_phase1_lava -246 -54 23 0_degrees none layer_by_layer 3.00
execute @e[family=evoker,scores={temp=41..60}] ~~~ execute @e[name=timeline,scores={temp2=3..5}] ~~~ execute @a ~~~ playsound bucket.empty_lava @s ~~~ 1 0.75
execute @e[family=evoker,scores={temp=41..60}] ~~~ execute @e[name=timeline,scores={temp2=0}] ~~~ structure load aw:7_5_phase1 -246 -54 23
### ~ 技能4：回血 ~
