...
# --- 第一轮 ---
## 出现掩体
execute @e[name=timeline,scores={temp2=20}] ~~~ structure load aw:7_5_shelter -238 -45 31 0_degrees none false true 8.00
...
# --- 第二轮 ---
## 出现掩体
execute @e[name=timeline,scores={temp2=13}] ~~~ structure load aw:7_5_shelter -238 -45 31 0_degrees none false true 5.00
...
# --- 第三轮 ---
## 出现掩体
execute @e[name=timeline,scores={temp2=6}] ~~~ structure load aw:7_5_shelter -238 -45 31 0_degrees none false true 2.00
