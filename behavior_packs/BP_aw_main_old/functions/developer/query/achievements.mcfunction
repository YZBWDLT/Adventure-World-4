...
tellraw @s[scores={temp=1}] {"rawtext":[{"translate":"§erecord.achievement.singlePlayer_completeMap = §a%%s §7# 神剑的恩赐 | 0=未完成，1=已完成","with":{"rawtext":[{"score":{"objective":"record","name":"achievement.singlePlayer_completeMap"}}]}}]}
...
tellraw @s[scores={temp=1}] {"rawtext":[{"translate":"§erecord.achievement.multiPlayer_completeMap = §a%%s §7# 齐心协力 | 0=未完成，1=已完成","with":{"rawtext":[{"score":{"objective":"record","name":"achievement.multiPlayer_completeMap"}}]}}]}
