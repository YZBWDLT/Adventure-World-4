...
### 0-1 | 醒来
execute if score levelCompleted data matches 0 if score level data matches 1 run function levels/open/stage1/gaming
### 0-2 | 与田英初次对话
execute if score levelCompleted data matches 0 if score level data matches 2 run function levels/open/stage2/gaming
### 0-3 | 到达时间神殿
...
### 0-2 | 与田英初次对话
execute if score levelCompleted data matches 1 if score level data matches 2 run function levels/open/stage2/after_gaming
### 0-3 | 到达时间神殿
