...
## 为超限玩家补充箭
execute as @a[tag=arrowOutOfLimit] run function lib/modify_data/supply_arrow
## 当data.allowArrowSupply=1时，为所有玩家补充箭
execute as @a if score allowArrowSupply data matches 1 run function lib/modify_data/supply_arrow
