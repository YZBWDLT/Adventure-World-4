...
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "data.maxMonsterAmount = §a%%s §7| 本关最大怪物数", "with": { "rawtext": [ { "score":{ "objective": "data", "name": "maxMonsterAmount" } } ] } } ] }
...
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "data.npcIsInteractable = §a%%s §7| NPC 是否允许交互 | 0：禁用，1：启用", "with": { "rawtext": [ { "score":{ "objective": "data", "name": "npcIsInteractable" } } ] } } ] }
...
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "settings.diffuculty = §a%%s §7| 地图难度", "with": { "rawtext": [ { "score":{ "objective": "settings", "name": "diffuculty" } } ] } } ] }
