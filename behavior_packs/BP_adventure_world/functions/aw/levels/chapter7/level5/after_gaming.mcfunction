...
# --- 入坑后 ---
    ...
    ## [120] 跳转到结束界面 | 如果为剧情模式，从stage1开始；如果为纯战斗模式，从stage3开始
    ...
    execute if score timeline active matches 3 if score timeline time matches 120.. if score storyMode settings matches 0 run function aw/levels/end/stage3/start
