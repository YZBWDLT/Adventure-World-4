...
# --- 检查玩家进入下一个关卡 ---
execute positioned -161 -17 110 positioned ~-0.95~-1~-0.95 as @a[dx=0.9,dy=3,dz=0.9,tag=!spectator,scores={deathState=0}] at @s run function aw/levels/chapter7/level2/start
