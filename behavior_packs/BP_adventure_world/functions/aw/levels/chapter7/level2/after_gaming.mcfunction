...
# --- 检查玩家进入下一个关卡 ---
execute positioned -194 -17 97 positioned ~-2.4~-1~-2.4 if score pausing data matches 0 as @a[scores={deathState=0,spectator=!1}] if entity @s[dx=3.8,dy=3,dz=3.8] unless entity @s[x=-192,y=-18,z=96,dz=2,dy=2] at @s run function aw/levels/chapter7/level3/start
