...
execute if score timeline time matches 380 run tellraw @a {"rawtext":[{"text":"* §c米云溪： §7嗯......按照铭文描述，这里是【§d红石神殿§7】......但这里可能没有怪物，§d会有一些谜题§7......"}]}
execute if score timeline time matches 460 run tellraw @a {"rawtext":[{"text":"* §f林乐（我）： §7谜题？听起来是你比较擅长的啊。莫非这里的红石机关就是谜题？可是......这些机关都处于§d被解开的状态§7啊。"}]}
