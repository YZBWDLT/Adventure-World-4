...
# --- 检查玩家进入下一个关卡 ---
execute positioned -126 5 52 positioned ~-1.2~-1~-1.2 as @a[dx=1.4,dy=3,dz=1.4,tag=!spectator,scores={deathState=0}] at @s run function aw/levels/chapter1/level2/start
