...
# --- 检查玩家进入下一个关卡 ---
execute positioned -126 6 52 positioned ~-2.4~-1~-2.4 if score pausing data matches 0 as @a[tag=!spectator,scores={deathState=0}] if entity @s[dx=3.8,dy=3,dz=3.8] unless entity @s[x=-127,y=5,z=50,dx=2,dy=2] at @s run function aw/levels/chapter1/level2/start
