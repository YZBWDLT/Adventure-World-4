...
execute as @a[tag=spectator,scores={deathState=0}] at @s anchored eyes if block ~~80~ barrier positioned -117 2 16 run function aw/lib/modify_data/out_of_border
