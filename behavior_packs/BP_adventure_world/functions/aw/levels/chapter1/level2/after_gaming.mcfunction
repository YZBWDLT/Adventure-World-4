...
# --- 检查玩家进入下一个关卡 ---
execute positioned -137 12 33 positioned ~-1.2~-1~-1.2 as @a[dx=1.4,dy=3,dz=1.4,tag=!spectator] run function aw/levels/chapter1/level3/start
execute positioned -137 12 33 positioned ~-1.2~-1~-1.2 as @e[dx=1.4,dy=3,dz=1.4,type=aw:wind_pearl] run kill @s
