...
# --- 检查玩家进入下一个关卡 ---
execute positioned -137 12 33 positioned ~-0.91~-1~-0.91 as @a[dx=0.82,dy=3,dz=0.82,tag=!spectator,scores={deathState=0}] run function aw/levels/chapter1/level3/start
