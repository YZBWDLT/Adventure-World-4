...
execute if score timeline time matches 1 run event entity @e[type=aw:npc,has_property={aw:is_author=true,aw:skin=3,aw:animation="none"}] aw:animation_speak
...
execute if score timeline time matches 60 run event entity @e[type=aw:npc,has_property={aw:is_author=true,aw:skin=3,aw:animation="none"}] aw:animation_speak
