...
# --- 检查玩家进入下一个关卡 ---
execute positioned -72 1 69 positioned ~-2.4~-1~-2.4 if score pausing data matches 0 as @a[tag=!spectator,scores={deathState=0}] if entity @s[dx=3.8,dy=3,dz=3.8] unless entity @s[x=-70,y=0,z=68,dz=2,dy=3] at @s run function aw/levels/chapter2/level2/start
