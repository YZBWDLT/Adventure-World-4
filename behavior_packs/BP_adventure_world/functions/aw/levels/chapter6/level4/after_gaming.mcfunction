...
execute if score timeline time matches 100 run effect @a levitation 30 0 true
execute if score timeline time matches 220.. run effect @a levitation 0 1 true
