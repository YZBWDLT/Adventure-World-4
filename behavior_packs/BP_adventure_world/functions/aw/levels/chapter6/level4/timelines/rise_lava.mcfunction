...
execute if score temp.lavaRiseCountdown time matches 0 if score @e[type=aw:blaze_king,c=1] health >= temp.bossHealthOneThird data run structure load aw:6_4_lava_1 -89 -40 21
execute if score temp.lavaRiseCountdown time matches 0 if score @e[type=aw:blaze_king,c=1] health < temp.bossHealthOneThird data run structure load aw:6_4_lava_2 -89 -40 21
