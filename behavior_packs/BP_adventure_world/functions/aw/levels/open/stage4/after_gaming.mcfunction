...
# --- 检查玩家进入下一个关卡 ---
execute positioned -18 -3 99 if entity @a[dx=5,dy=0.3,dz=3] run function aw/levels/open/stage5/start

# --- 玩家入水后，触发彩蛋 ---

## 检测并触发
execute as @a at @s if block ~~~ water if score timeline time matches 0 run function aw/levels/open/stage4/events/player_in_water
