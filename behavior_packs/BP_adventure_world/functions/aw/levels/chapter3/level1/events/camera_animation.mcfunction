...
execute if score timeline time matches 300 run tellraw @a {"rawtext":[{"text":"* §c米云溪： §7【暨将传说武器“旷野之剑”传承于后人】"}]}
...
## [540] 相机视角：镜头给到米云溪
execute if score timeline time matches 540 run tellraw @a {"rawtext":[{"text":"* §f林乐（我）： §7原来这里的修建和过去的我们还有关系呢。"}]}
