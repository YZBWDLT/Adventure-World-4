...
# --- 检查玩家进入下一个关卡 ---
execute positioned -173 18 -8 positioned ~-0.91~-1~-0.91 as @a[dx=0.82,dy=3,dz=0.82,tag=!spectator,scores={deathState=0}] at @s run function aw/levels/chapter4/level0/start
