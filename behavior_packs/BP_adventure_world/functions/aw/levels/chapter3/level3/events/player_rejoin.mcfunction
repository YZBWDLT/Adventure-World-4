...
## 传送玩家到重生点处 | 仅限多人模式下运行
execute if score playerAmount data matches 2.. run tp @s -163 -20 28

# --- 完成关卡前 ---

## 设置玩家的重生点
execute if score levelCompleted data matches 0 run spawnpoint @s -172 -20 11
## 设置玩家为旁观模式 | 仅限多人模式下运行
...
## 设置玩家的重生点
execute if score levelCompleted data matches 1 run spawnpoint @s -163 -20 28
