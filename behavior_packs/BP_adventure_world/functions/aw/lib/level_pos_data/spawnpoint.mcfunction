...
# 第 3 章
    execute if score chapter data matches 3 if score level data matches 0 run spawnpoint @s -173 -20 30
    execute if score chapter data matches 3 if score level data matches 1 run spawnpoint @s -188 -20 29
    execute if score chapter data matches 3 if score level data matches 2 run spawnpoint @s -172 -20 11
    execute if score chapter data matches 3 if score level data matches 3 run spawnpoint @s -163 -20 28
    execute if score chapter data matches 3 if score level data matches 4 run spawnpoint @s -170 -14 23

# 第 4 章
    execute if score chapter data matches 4 if score level data matches 0 run spawnpoint @s -173 18 -8
    execute if score chapter data matches 4 if score level data matches 1 run spawnpoint @s -168 18 -20
    execute if score chapter data matches 4 if score level data matches 2 run spawnpoint @s -156 8 -1
    execute if score chapter data matches 4 if score level data matches 3 run spawnpoint @s -156 -11 14
    execute if score chapter data matches 4 if score level data matches 4 run spawnpoint @s -141 -30 6

# 第 5 章
    execute if score chapter data matches 5 if score level data matches 0 run spawnpoint @s -95 -30 -6
...
# 第 7 章
    ...
    execute if score chapter data matches 7 if score level data matches 4 run spawnpoint @s -225 -17 99
    execute if score chapter data matches 7 if score level data matches 5 run spawnpoint @s -225 -47 44

# 结束
    execute if score chapter data matches 10 if score level data matches 1 run spawnpoint @s -27 7 -48
    execute if score chapter data matches 10 if score level data matches 2 run spawnpoint @s -27 7 -48
    execute if score chapter data matches 10 if score level data matches 3 run spawnpoint @s -16 1 82
