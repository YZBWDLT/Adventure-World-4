...
# 仅中国版，仅1人时执行，以适应中国版电脑版的要求
    ...
    execute if score client data matches 1 run function aw/lib/modify_data/init/gamerule
    execute if score client data matches 1 run gamemode adventure @s
    execute if score client data matches 1 run weather clear
