...
## 重置gamerule
execute if score developerMode settings matches 0 run function aw/lib/modify_data/init/gamerule
...
## 使用开发者模式专有的gamerule
execute if score developerMode settings matches 1 run function aw/developer/gamerule
