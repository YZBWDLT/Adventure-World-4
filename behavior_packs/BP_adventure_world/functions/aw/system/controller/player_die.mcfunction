...
execute if score levelCompleted data matches 0 if score playerAmount data matches 2.. as @a[scores={deathState=2},tag=!spectator] run function aw/lib/modify_data/death_message
