...
execute if score developerMode settings matches 1 run tellraw @s {"rawtext":[{"translate":"§erecord.achievement.singlePlayer.notDied = §a%%s §7# 让田英睡觉去吧！ | 0=未完成，1=已完成","with":{"rawtext":[{"score":{"objective":"record","name":"achievement.singlePlayer.notDied"}}]}}]}
...
execute if score developerMode settings matches 1 run tellraw @s {"rawtext":[{"translate":"§erecord.achievement.multiPlayer.notDied = §a%%s §7# 人多力量大 | 0=未完成，1=已完成","with":{"rawtext":[{"score":{"objective":"record","name":"achievement.multiPlayer.notDied"}}]}}]}
