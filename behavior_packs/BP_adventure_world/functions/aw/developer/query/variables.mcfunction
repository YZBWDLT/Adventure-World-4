...
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "data.isSingleLevel = §a%%s §7| 是否为单关卡试炼 | 0：全流程，1：单关卡", "with": { "rawtext": [ { "score":{ "objective": "data", "name": "isSingleLevel" } } ] } } ] }
...
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "record.difficulty = §a%%s §7| 通关时的难度", "with": { "rawtext": [ { "score":{ "objective": "record", "name": "difficulty" } } ] } } ] }
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "record.failedCount = §a%%s §7| 通关时的失败次数", "with": { "rawtext": [ { "score":{ "objective": "record", "name": "failedCount" } } ] } } ] }
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "record.hasCheat = §a%%s §7| 通关时是否有人作弊 | 0：无，1：有", "with": { "rawtext": [ { "score":{ "objective": "record", "name": "hasCheat" } } ] } } ] }
...
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "record.playerAmount = §a%%s §7| 通关时的玩家人数", "with": { "rawtext": [ { "score":{ "objective": "record", "name": "playerAmount" } } ] } } ] }
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "record.playedSecond = §a%%s §7| 通关时的游玩秒数", "with": { "rawtext": [ { "score": { "objective": "record", "name": "playedSecond" } } ] } } ] }
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "record.playedMinute = §a%%s §7| 通关时的游玩分钟数", "with": { "rawtext": [ { "score": { "objective": "record", "name": "playedMinute" } } ] } } ] }
execute if score developerMode settings matches 1 run tellraw @s { "rawtext": [ { "translate": "record.potionUsed = §a%%s §7| 通关时是否有玩家使用过主药水或副药水 | 0：没有，1：有", "with": { "rawtext": [ { "score":{ "objective": "record", "name": "potionUsed" } } ] } } ] }
