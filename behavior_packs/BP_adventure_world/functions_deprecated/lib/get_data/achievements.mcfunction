...
# 神剑的恩惠 - 通过剑之试炼
execute @e[name=maxPlayersAmount,scores={data=1}] ~~~ scoreboard players set achievement.singlePlayer.finishMap record 1
...
# --- 多人时 ---
# 齐心协力 - 通过剑之试炼
execute @e[name=maxPlayersAmount,scores={data=2..}] ~~~ scoreboard players set achievement.multiPlayer.finishMap record 1
