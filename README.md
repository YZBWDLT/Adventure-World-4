...
> 备注：因为我总是忘记在 GitHub 上上传测试版本，最近更新的又比较频繁，现在正式版已经发布，所以测试版本我就不发了。感兴趣的玩家可以来我们的 QQ 测试群：673941729 来找 Pre 2 到 RC 2 的全版本。详细更新日志可以在我们的群文档找到，地址为https://docs.nekoawa.com/docs/resources/completed/adventure_world_4/update_log/4_2 。
> 下载指南：**国际版玩家请直接下载 Release - 4.2 版本下面的 `4.2.mcworld`，直接打开即可游玩**。中国版玩家请移步资源中心查找，如果您需要中国版的源代码，请切换到ChinaVersion分支，该分支相比于国际版（main）分支而言，只是阉割了非原创作者的皮肤。
